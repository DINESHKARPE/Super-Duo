...
/**
 * Manages the camera in conjunction with an underlying {@link com.google.android.gms.vision.Detector}.
 ...
 * <p/>
 * The following Android permission is required to use the camera: <ul>
 * <li>android.permissions.CAMERA</li> </ul>
 */
...
public class CameraSource {
    ...
    public interface PictureCallback {
        /**
         * Called when image data is available after a picture is taken.  The format of the data is
         * a jpeg binary.
         */
    ...
    public interface AutoFocusCallback {
         ...
         * <p/>
         * The auto-focus routine does not lock auto-exposure and auto-white balance after it
         * completes.
         *
    ...
    /**
     * Callback interface used to notify on auto focus start and stop. <p/> <p>This is only
     * supported in continuous autofocus modes -- {@link Camera.Parameters#FOCUS_MODE_CONTINUOUS_VIDEO}
     * and {@link Camera.Parameters#FOCUS_MODE_CONTINUOUS_PICTURE}. Applications can show autofocus
     * animation based on this.</p>
     */
     ...
     * <p/>
     * Even though we may only need the preview size, it's necessary to find both the preview size
     * and the picture size of the camera together, because these need to have the same aspect
