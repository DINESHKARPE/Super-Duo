...
import com.udacity.footballscores.data.DatabaseContract.scores_table;
...
public class ScoresDBHelper extends SQLiteOpenHelper
{
    ...
    {
        final String CreateScoresTable = "CREATE TABLE " + com.udacity.footballscores.data.DatabaseContract.SCORES_TABLE + " ("
