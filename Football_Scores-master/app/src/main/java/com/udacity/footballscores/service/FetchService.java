...
import com.udacity.footballscores.MainActivity;
import com.udacity.footballscores.R;
import com.udacity.footballscores.Util;
...
{   public static boolean data_ok;
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                        ...
                        League.equals(LEAGUE_ONE))
                {
                    ...
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.MATCH_ID,match_id);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.DATE_COL,mDate);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.TIME_COL,mTime);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.HOME_COL,Home);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.AWAY_COL,Away);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.HOME_GOALS_COL,Home_goals);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.AWAY_GOALS_COL,Away_goals);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.LEAGUE_COL,League);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.MATCH_DAY,match_day);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.HOME_TEAM_LOGO_URL,LogoUrlHomeTeam);
                    match_values.put(com.udacity.footballscores.data.DatabaseContract.scores_table.AWAY_TEAM_LOGO_URL,LogoUrlAwayTeam);
            ...
            inserted_data = mContext.getContentResolver().bulkInsert(
                    com.udacity.footballscores.data.DatabaseContract.BASE_CONTENT_URI,insert_data);
    ...
    private String getLogoLocation (String teamUrl, String teamName) {
        ...
        fileName = Util.getApplicationDirectory() + "/image_files/" + teamName;
        if (Util.doesFileExist(fileName)) {
            ...
            try {
                if (JSON_data != null) {
                    ...
                    if (tempString.contains(".svg")) {
                        crestUrlString = Util.fixUrlIfSvg(tempString);
                    } else {
            ...
            if (Util.isExternalStorageAvailable() && crestUrlString != null) {
                Log.d("A_URL",crestUrlString + "   " + teamName);
                Util.downloadImageFile(this,crestUrlString,teamName);
                return Util.getApplicationDirectory() + "/image_files/" + teamName;
            } else {
